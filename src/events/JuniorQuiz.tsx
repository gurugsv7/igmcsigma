...
<h2 className="text-3xl font-bold text-center text-cyan-300 mb-2 mt-12">Junior Quiz</h2>
<h3 className="text-xl font-semibold text-center text-purple-300 mb-4">Vistura</h3>
      <div className="mb-2">
