...
<p className="text-lg text-white/80 mb-2">
  Emergency protocols in dental clinics, BLS, and handling medical emergencies during dental procedures.
</p>
<ul className="text-white/70 mb-4 list-disc pl-6">
  <li>Identifying medical emergencies in dental settings</li>
  <li>Managing syncope, hypoglycemia, chest pain</li>
...
export default function ExodontiaXPage() {
  return (
    <>
      <ExodontiaX />
      <RegisterNowButton />
